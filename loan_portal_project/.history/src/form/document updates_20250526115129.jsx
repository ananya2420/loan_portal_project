      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-end mb-4">
          <button
            ...
            className="px-3 py-1 ml-4 text-sm text-black transition bg-yellow-400 rounded hover:bg-yellow-500"
          >
            Toggle Theme
          </button>
        </div>
            ...
            <div key={step} className="flex flex-col items-center col-span-1">
              ...
              <span
                className={`mt-1 truncate ${
                  theme === 'dark' ? 'text-yellow-300' : 'text-green-700'
                }`}
        ...
        >
          ...
          <div className="flex justify-between pt-6">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-2 rounded transition bg-outline-600 text-white hover:bg-outline-700"
            >
              Back
            </button>
            <button
              type="submit"
              className="px-6 py-2 rounded transition bg-black text-white hover:bg-gray-900"
            >
              Submit Documents
            </button>
          </div>
