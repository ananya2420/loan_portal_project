...
<div className="relative mb-6">
  ...
  <div className="bg-white border border-emerald-400 rounded-xl shadow-sm p-4">
    <DatePicker
      ...
      dropdownMode="select"
      inline
      calendarClassName="custom-calendar bg-white rounded-xl shadow-lg p-4"
      className="hidden" // Hides the default input since we're using inline calendar
    />
  </div>
