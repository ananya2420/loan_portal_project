            ...
            <div key={step} className="flex flex-col items-center col-span-1">
              <span
                className={`w-7 h-7 flex items-center justify-center rounded-full font-bold ${
                  step === currentStep ? 'bg-blue-600 text-white' : 'bg-gray-300 text-purple-600'
                }`}
              >
                {step}
              </span>
        ...
        >
          ...
          >
            {(allFields.name || focusedField === 'name') && (
              <label className="block mb-1 text-sm font-medium" style={{ color: '#6B7280' }}>
                Full Name
              </label>
            )}
            <input
          ...
          <div className="flex justify-between mt-4">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-3 text-white transition duration-300 bg-rose-500 rounded-lg hover:bg-rose-600"
            >
              Back
            </button>
            <button
