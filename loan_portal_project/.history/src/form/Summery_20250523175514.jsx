          ...
          <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-700 dark:text-gray-300">
                  {section.content.map((item, j) => (
                    <div key={j} className="break-words">
                      <strong className="text-indigo-600">{item.label}:</strong>{' '}
            ...
            <div className="flex flex-wrap gap-3 justify-between mt-6">
              ...
              <button
                ...
                className="px-5 py-2 bg-indigo-700 hover:bg-indigo-800 text-white rounded text-sm transition"
              >
                View Full Summary
              </button>
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-700 hover:bg-blue-800 text-white rounded text-sm transition"
              >
                Next
              </button>
            </div>
