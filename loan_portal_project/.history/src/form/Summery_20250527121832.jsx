...
// Define your stepRoutes here or import it if external
const stepRoutes = [
  '/apply/personal-info',
  '/apply/employee-details',
  '/apply/loan-details',
...
const Summary = () => {
  ...
  useEffect(() => {
    ...
    if (!hasAnyData) {
      ...
      // Navigate to the document updates route using stepRoutes
      navigate(stepRoutes[3]); // index 3 is '/apply/document-updates'
    } else {
      reset({
        personalInfo,
        employeeDetails,
      ...
      <div className="max-w-3xl mx-auto mb-2">
        <div className="flex justify-between text-xs font-semibold text-gray-500 dark:text-gray-400">
          {[
            ...
            const isActive = stepNumber === 6; // Step 6 is Summary
            return (
              <div
                key={stepLabel}
        ...
        {isEditing ? (
              ...
              <button
                ...
                onClick={() => {
                  if (editStep > 0) {
                    ...
                    setIsEditing(false);
                    setEditStep(0);
                    // Navigate to summary route
                    navigate(stepRoutes[4]); // index 4 is '/apply/summary'
                  }
                }}
          ...
          <>
            {[  
              ...
              <section
                key={i}
                className={`p-4 rounded border ${theme === 'dark' ? 'bg-gray-700' : 'bg-gray-50'} space-y-2`}
              >
            ...
            <div className="flex flex-wrap gap-2 justify-between mt-4">
              <button
                onClick={() => navigate(stepRoutes[3])} // Back to Document Updates
                className="px-4 py-1.5 bg-gray-400 text-white rounded text-sm"
              >
                Back
              </button>
              ...
              <button
                onClick={() => navigate(stepRoutes[4])} // View Full Summary, assumed here as same as summary
              ...
              <button
                onClick={() => navigate(stepRoutes[5])} // Next to Review
                className="px-4 py-1.5 bg-blue-600 text-white rounded text-sm"
              >
                Next
              </button>
