...
const Summary = () => {
  ...
  // Current step is 6 because this is Summary page
  const currentStep = 6;
  ...
  return (
    <div className={`min-h-screen p-4 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-black'}`}>
      ...
      {/* Step Indicator */}
      <div className="mb-6 grid grid-cols-8 gap-x-3 gap-y-2 text-xs font-semibold text-center max-w-3xl mx-auto">
        {[
          { step: 1, label: 'Apply' },
          ...
          <>
            {[ 
              ...
              <div key={idx} className="mb-4">
                <h3 className="text-xl font-semibold mb-2 border-b border-gray-400">{title}</h3>
                <ul>
            ...
            <div className="text-center">
              <button
                ...
                className="px-6 py-2 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-lg font-semibold"
              >
                Edit
              </button>
            </div>
