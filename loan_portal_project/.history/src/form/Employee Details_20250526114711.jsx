        ...
        >
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-2 font-semibold text-gary bg-outline-500 rounded hover:bg-outline-600"
            >
              Back
            </button>
            <button
              type="submit"
              className="px-6 py-2 font-semibold text-white bg-purple-600 rounded hover:bg-emerald-700"
            >
              Next
            </button>
          </div>
