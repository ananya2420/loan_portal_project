...
<div className="relative mb-6">
  ...
  <DatePicker
    ...
    className="w-full rounded-xl border border-emerald-400 bg-white px-4 py-3 text-gray-900 placeholder-gray-400
               shadow-sm focus:border-emerald-500 focus:outline-none focus:ring-2 focus:ring-emerald-400
               transition duration-200"
  />

  {errors.dob && (
    <p className="mt-2 text-sm text-red-500">{errors.dob.message}</p>
  )}
</div>
