  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        ...
        {/* Step Indicator */}
        <div className="mb-6 grid grid-cols-8 gap-x-3 gap-y-2 text-xs font-semibold text-center text-black">
          {[
            { step: 1, label: 'Apply' },
            ...
            <div key={step} className="flex flex-col items-center col-span-1">
              <span
                className={`w-7 h-7 flex items-center justify-center rounded-full font-bold ${
                  step === currentStep
                    ? 'bg-blue-600 text-black'       // black text for active step number
                    : 'bg-purple-200 text-black'     // black text for inactive step numbers
                }`}
              >
                {step}
              </span>
        ...
        >
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-2 font-semibold text-gray bg-outline-500 rounded hover:bg-outline-600"
            >
              Back
            </button>
            <button
