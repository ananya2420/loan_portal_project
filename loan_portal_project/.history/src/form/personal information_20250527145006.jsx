...
<div className="relative">
  ...
  <input
    ...
    onBlur={() => setFocusedField('')}
    className="custom-date-input w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-gray-800 transition duration-300"
  />
