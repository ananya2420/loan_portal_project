  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-6 transition-all duration-300 ${
        theme === 'gray' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-700'
      }`}
    >
            ...
            <div key={step} className="flex flex-col items-center col-span-1">
              ...
              <span
                className={`mt-1 truncate ${
                  step === currentStep ? 'text-blue-600 font-semibold' : 'text-gray-600'
                }`}
              >
                {{
                  1: 'Apply',
        ...
        >
          ...
          >
            {(allFields.name || focusedField === 'name') && (
              <label className="block mb-1 text-sm font-medium text-blue-600 bg-gray-200 px-1 rounded">
                Full Name
              </label>
            )}
            <input
          ...
          <div>
            <label className="block mb-1 text-sm font-medium text-pink-600 bg-gray-200 px-1 rounded">
          ...
          <div
            ...
            onMouseLeave={() => setHoverField('')}
          >
            <label className="block mb-1 text-sm font-medium text-green-600 bg-gray-200 px-1 rounded">
              Phone Number
            </label>
            <input
          ...
          <div
            ...
            onMouseLeave={() => setHoverField('')}
          >
            <label className="block mb-1 text-sm font-medium text-purple-600 bg-gray-200 px-1 rounded">
              Email
            </label>
            <input
              type="email"
