        ...
        <div className="mb-6 grid grid-cols-8 gap-x-3 gap-y-2 text-xs font-semibold text-center">
          {[
            ...
            <div key={step} className="flex flex-col items-center col-span-1">
              ...
              <span className={`mt-1 truncate ${theme === 'dark' ? 'text-white' : 'text-black'}`}>
                {label}
              </span>
            </div>
          ))}
        ...
        >
          ...
          <div>
            <input
              ...
              className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder:text-gray-500 dark:placeholder:text-gray-300 ${inputTextClass} ${bgInputClass}`}
            />
            {errors.company && (
          ...
          <div>
            ...
            <select
              ...
              className={`w-full px-4 py-2 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-black dark:text-white ${bgInputClass}`}
            >
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              onClick={handleBack}
              className="border border-gray-200 text-gray-700 px-4 py-2 rounded hover:bg-gray-100 transition"
            >
              Back
            </button>
            <button
