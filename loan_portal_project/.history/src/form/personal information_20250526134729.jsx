        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-indigo-400 rounded focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          ...
          <div>
            ...
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 border border-rose-400 rounded focus:outline-none focus:ring-2 focus:ring-rose-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 border border-emerald-400 rounded focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 border border-amber-400 rounded focus:outline-none focus:ring-2 focus:ring-amber-500"
            />
