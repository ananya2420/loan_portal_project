...
const LoanDetails = () => {
  ...
  // Corrected step routes for proper navigation
  const stepRoutes = {
    1: '/apply',               // corrected from '/apply/apply'
    ...
    6: '/apply/summary',
    7: '/apply/review',
    8: '/thank-you',           // corrected from '/apply/thank-you'
  };
    ...
    >
      <div className="w-full max-w-md">
        ...
        <div className="mb-6 grid grid-cols-8 gap-x-3 gap-y-2 text-xs font-semibold text-center">
          {[
            ...
            >
              ...
              <span
                className={`mt-1 truncate ${theme === 'dark' ? 'text-white' : 'text-black'}`}
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="relative pt-1 mb-6">
            <div className="flex items-center justify-between mb-2">
              <span className="inline-block px-2 py-1 text-xs font-semibold text-teal-700 uppercase bg-teal-100 rounded-full">
                Step 4 of 8
              </span>
              <span className="text-xs font-semibold text-teal-700">40%</span>
            </div>
        ...
        >
          ...
          {/* Loan Amount */}
          <label className="block text-sm font-medium mb-1 text-black">Loan Amount</label>
          <div
          ...
          {/* Loan Type */}
          <label className="block text-sm font-medium mb-1 mt-4 text-black">
