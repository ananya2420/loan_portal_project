              ...
              >
                <div
                  className={`rounded-full w-6 h-6 flex items-center justify-center mb-1 border ${
                    isActive
                      ? 'border-white-600 text-white-200 bg-white-200 dark:bg-emerald-700'
          ...
          <>
            ...
            <div className="flex flex-wrap gap-2 justify-between mt-4">
              ...
              <button
                ...
                className="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-800 text-white rounded text-sm shadow-md"
              >
                View Full Summary
              </button>
