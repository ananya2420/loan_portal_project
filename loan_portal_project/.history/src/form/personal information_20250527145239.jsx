...
<div className="relative">
  ...
  <input
    ...
    onBlur={() => setFocusedField('')}
    className="custom-date-input w-full px-5 py-3 text-base border border-emerald-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white text-gray-900 transition duration-300 shadow-sm"
  />
  {errors.dob && (
