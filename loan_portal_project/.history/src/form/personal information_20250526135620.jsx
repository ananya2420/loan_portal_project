      ...
      <div className="w-full max-w-md">
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="px-3 py-1 ml-4 text-sm text-white transition bg-green-500 rounded hover:bg-green-600"
          >
            Toggle Theme
          </button>
        </div>
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-purple-100 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          <div>
            ...
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-yellow-100 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-green-100 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-pink-100 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          <div className="flex justify-between mt-4">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-3 text-gray transition duration-300 bg-outline-500 rounded-lg hover:bg-outline-600"
            >
              Back
            </button>
            <button
