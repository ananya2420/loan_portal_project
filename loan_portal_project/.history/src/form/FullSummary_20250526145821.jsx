    ...
    >
      <div className="max-w-3xl mx-auto mb-2 flex justify-end">
        <button
          ...
          className="px-3 py-1.5 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white rounded text-sm shadow-lg hover:from-indigo-700 hover:via-purple-700 hover:to-pink-700 transition"
        >
          Back to Summary
        </button>
      </div>
      ...
      >
        <h2 className="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded text-sm shadow-md">
          Full Summary
        </h2>
