        ...
        >
          ...
          <div>
            ...
            <input
              ...
              onBlur={() => setFocusedField('')}
              className={`w-full px-4 py-2 border-gray-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                theme === 'dark' ? 'text-white' : 'text-gray-900'
              }`}
            />
            {errors.dob && (
          ...
          >
            ...
            <input
              ...
              onBlur={() => setFocusedField('')}
              className={`w-full px-4 py-2 border-black-200 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 ${
                theme === 'dark' ? 'text-white' : 'text-gray-900'
              }`}
            />
            {errors.phone && (
