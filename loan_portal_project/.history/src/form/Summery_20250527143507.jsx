...
{/* Step Indicator */}
<div className="mb-6 grid grid-cols-11 gap-x-3 gap-y-2  text-xs font-semibold text-center max-w-3xl mx-auto">
  {[
    { step: 1, label: 'Apply' },
    ...
    <div
      key={step}
      className="mb-6 grid grid-cols-8 gap-x-3 gap-y-2 text-xs font-semibold text-center max-w-3xl mx-auto"
      onClick={() => {
        switch(step) {
