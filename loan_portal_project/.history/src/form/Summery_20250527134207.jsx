...
{/* Step Indicator */}
<div className="mb-6 grid grid-cols-8 gap-x-1 gap-y-2 text-xs font-semibold text-center">
  {[
    { step: 1, label: 'Apply' },
    { step: 2, label: 'PersonalInfo' },
    { step: 3, label: 'EmployeeDetails' },
    { step: 4, label: 'LoanDetails' },
    { step: 5, label: 'DocumentUpdates' },
    { step: 6, label: 'Summary' },
    { step: 7, label: 'Review' },
    { step: 8, label: 'Thankyou' },
  ].map(({ step, label }) => (
    <div
      key={step}
