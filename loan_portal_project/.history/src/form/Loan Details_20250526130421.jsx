  ...
  return (
    <div
      className={`min-h-screen flex items-center justify-center p-6 transition-all duration-300 ${
        // NOTE: Step 4 (Loan Details) background color must be blue.
        // Currently using:
        // dark theme: 'bg-gray-900 text-white'
        // light theme: 'bg-gray-100 text-black'
        // To apply blue background, replace with e.g.
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-end mb-4">
          <button
            ...
            className="px-3 py-1 ml-4 text-sm font-semibold transition bg-emerald-500 text-white rounded hover:bg-emerald-600"
          >
            Toggle Theme
          </button>
        </div>
        ...
        >
          ...
          <div className="flex justify-between pt-4">
            <button
              type="button"
              onClick={handleBack}
              className="px-4 py-2 text-gray bg-outline-500 rounded hover:bg-outline-600"
            >
              Back
            </button>
            <button
