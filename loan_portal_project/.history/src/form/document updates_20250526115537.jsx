      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-end mb-4">
          <button
            ...
            className="px-3 py-1 ml-4 text-sm text-black transition bg-className={`cursor-pointer inline-block px-6 py-2 rounded transition ${
                'bg-green-600 text-white hover:bg-green-700'
              }`}-400 rounded hover:bg-yellow-500"
          >
            Toggle Theme
          </button>
        </div>
