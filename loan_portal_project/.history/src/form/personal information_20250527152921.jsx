...
<div className="relative">
  <DatePicker
    ...
    showYearDropdown
    dropdownMode="select"
    className="py-1 px-10 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 text-left"
    style={{ width: '400px', paddingLeft: '100px', paddingRight: '100px' }}
  />
</div>
