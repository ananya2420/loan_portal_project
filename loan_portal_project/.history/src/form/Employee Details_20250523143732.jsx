...
const EmployeeDetails = () => {
  ...
  const theme = useSelector((state) => state.theme.theme); // theme string
  const savedData = useSelector((state) => state.formData.employeeDetails); // camelCase key
  ...
  // Populate form fields with savedData when it changes
  useEffect(() => {
    if (savedData) {
