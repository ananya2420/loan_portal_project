        ...
        >
          ...
          <div className="flex justify-between pt-6">
            <button
              type="button"
              onClick={handleBack}
              className="px-6 py-2 bg-outline-400 text-gray rounded hover:bg-outline-500 transition"
            >
              Back
            </button>
            <button
              type="submit"
              className="px-6 py-2 bg-emerald-600 text-white rounded hover:bg-green-700 transition"
            >
              Submit Documents
            </button>
          </div>
