    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Loan Amount */}
          <label className="block text-sm font-medium mb-1 text-blue-700">Loan Amount <span className="text-red-500">*</span></label>
          <div
          ...
          {/* Loan Type */}
          <label className="block text-sm font-medium mb-1 mt-4 text-blue-700">
