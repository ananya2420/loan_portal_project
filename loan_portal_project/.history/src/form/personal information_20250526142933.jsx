...
// Import the Redux action to save personal info
...
const PersonalInformation = () => {
  ...
  // Get saved personalInfo from Redux to prefill form
  ...
  // On form submit, save to Redux then navigate
  const onSubmit = (data) => {
    dispatch(setPersonalInfo(data));  // Save personal info in Redux store
        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 border border-grerounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
