...
const FullSummary = () => {
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-100 text-black dark:bg-gray-900 dark:text-white">
      <div className="max-w-3xl mx-auto p-6 rounded-xl shadow bg-white dark:bg-gray-800 space-y-6">
        <h2 className="text-3xl font-bold mb-6 text-center">
          Loan Application Full Summary
        </h2>

        <section className="p-4 rounded border bg-gray-50 dark:bg-gray-700 space-y-2">
          ...
          <p>
            ...
            {personalInfo.dob || personalInfo.dateOfBirth || 'N/A'}
          </p>
          <p>
            <strong>Phone:</strong>{' '}
            {personalInfo.phone || personalInfo.phoneNumber || 'N/A'}
          </p>
          <p>
        ...
        <section className="p-4 rounded border bg-gray-50 dark:bg-gray-700 space-y-2">
          ...
          <p>
            <strong>Status:</strong> {employeeDetails.status || 'N/A'}
          </p>
          <p>
            <strong>Company:</strong> {employeeDetails.company || 'N/A'}
          </p>
          <p>
            <strong>Monthly Income:</strong>{' '}
            {employeeDetails.income || employeeDetails.monthlyIncome || 'N/A'}
          </p>
          <p>
          ...
          <p>
            <strong>Tax ID:</strong> {employeeDetails.taxId || 'N/A'}
          </p>
        </section>
        ...
        <section className="p-4 rounded border bg-gray-50 dark:bg-gray-700 space-y-2">
          ...
          <p>
            <strong>Amount:</strong> {loanDetails.amount || 'N/A'}
          </p>
          <p>
            <strong>Type:</strong> {loanDetails.type || 'N/A'}
          </p>
          <p>
            <strong>Term:</strong>{' '}
            {loanDetails.repaymentTerm
              ? `${loanDetails.repaymentTerm} months`
              : loanDetails.term || 'N/A'}
          </p>
          <p>
            <strong>EMI Date:</strong> {loanDetails.emiDate || 'N/A'}
          </p>
        </section>
