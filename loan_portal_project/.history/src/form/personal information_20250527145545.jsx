...
<div className="relative">
  ...
  <DatePicker
    ...
    onChange={(date) =>
      setValue('dob', date?.toISOString().split('T')[0], { shouldValidate: true })
    }
    ...
    dropdownMode="select"
    inline
    calendarClassName="w-full p-4 rounded-xl shadow-lg bg-white text-gray-800 grid grid-cols-3 gap-4"
    className="w-full px-5 py-3 text-base border border-emerald-500 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-white text-gray-900 transition duration-300 shadow-sm"
  />
  {errors.dob && (
