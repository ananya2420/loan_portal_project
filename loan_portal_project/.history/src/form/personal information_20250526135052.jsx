        ...
        >
          ...
          >
            ...
            <input
              ...
              className="w-full px-4 py-2 bg-blue-50 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          <div>
            ...
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-yellow-50 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-green-50 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
          ...
          >
            <input
              ...
              onBlur={() => setFocusedField('')}
              className="w-full px-4 py-2 bg-red-50 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
