...
const LoginFormComponent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center py-10 px-4">
      ...
      >
        <h2 className="text-3xl font-bold text-center text-black-600 mb-6">Login</h2>
        ...
        <div className="flex justify-between items-center mt-6">
          ...
          <button
            type="submit"
            className="px-5 py-2 bg-emerald-500 text-white font-semibold rounded-lg hover:bg-emerald-600 transition"
            disabled={loading}
          >
      ...
      {user && (
        <div className="mt-4">
          <button
            ...
            className="px-5 py-2 bg-emerald-600 text-white font- rounded-lg hover:bg-emerald-700 transition"
          >
            Logout
          </button>
        </div>
