    ...
    >
      ...
      <div className="w-full max-w-md flex justify-end mb-6">
        <button
          ...
          className="text-sm px-3 py-1 bg-emerald-500 text-white rounded hover:bg-emerald-600 transition"
        >
          Toggle Theme
        </button>
      </div>
      ...
      <div className="w-full max-w-md mx-auto">
        <div className="relative pt-1 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs font-semibold text-purple-700">80%</span>
          </div>
      ...
      >
        ...
        <div className="flex justify-center gap-4 mt-6">
          ...
          <button
            ...
            className="px-8 py-2 font-semibold text-white bg-emerald-600 rounded-lg hover:bg-green-700 transition"
          >
            Go to Login
          </button>
        </div>
        ...
        <div className="flex justify-center gap-4 mt-6">
          <button
            onClick={handleBack}
            className="px-5 py-2 text-black bg-outline-600 rounded hover:bg-outline-700 transition"
          >
            Back
          </button>

          <button
            className="px-5 py-2 text-white bg-indigo-600 rounded hover:bg-indigo-700 transition"
          >
            Next
          </button>
        </div>
