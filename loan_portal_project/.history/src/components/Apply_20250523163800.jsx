    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="mb-4">
            <p className="text-lg text-center text--700">
          ...
          <div className="flex justify-between mt-6">
            <button
              type="button"
              onClick={goBack}
              className="bg-gray-600 text-white px-4 py-2 rounded shadow hover:bg-gray-700 focus:ring-2 focus:ring-gray-500 transition"
            >
              Back
            </button>
            <button
              type="submit"
              className="bg-amber-600 text-white px-4 py-2 rounded shadow hover:bg-amber-700 focus:ring-2 focus:ring-amber-400 transition"
            >
              {step === 7 ? 'Submit' : 'Next'}
            </button>
          </div>
