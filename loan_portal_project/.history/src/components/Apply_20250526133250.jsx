        ...
        >
          ...
          <div className="flex justify-between">
            <button
              type="button"
              onClick={goBack}
              className="bg-outline-400 text-gray px-4 py-2 rounded hover:bg-outline-500"
            >
              Back
            </button>
            <button
              type="submit"
              className="bg-#D50B8B#DC8BE0#64E2B7-500 text-white px-4 py-2 rounded hover:bg-#D50B8B#DC8BE0#64E2B7-600"
            >
              {step === 7 ? 'Submit' : 'Next'}
            </button>
          </div>
