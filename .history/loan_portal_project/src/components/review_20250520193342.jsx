...
const steps = [
  ...
  'Review',
  'Thank You',
  'Final Step', // Added 8th step here
];
...
const Review = () => {
  ...
  const currentStepIndex = 7; // zero-based index for step 8 (Final Step)
  ...
  return (
    ...
    >
      ...
      >
        {/* Full Steps Navigation */}
        <div className="mb-6">
          {steps.map((step, index) => (
            <div
              key={step}
              className={`flex items-center justify-between px-3 py-1 mb-1 rounded ${
        ...
        <div className="relative pt-1 mb-6">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-xs font-semibold text-teal-600">Final Step</span>
          </div>
          <div className="flex h-2 overflow-hidden text-xs bg-teal-200 rounded">
            <div
              style={{ width: isSubmitting ? '100%' : '100%' }}
