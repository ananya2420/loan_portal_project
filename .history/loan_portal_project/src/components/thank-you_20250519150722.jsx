...
const Thankyou = () => {
  ...
  return (
    ...
    >
      {/* Toggle Theme Button - Outside main content, top right aligned */}
      ...
      {/* Thank You Section */}
      <div
        className={`relative max-w-4xl mx-auto p-6 rounded-lg shadow-lg mt-4 transition-all duration-300 ${
