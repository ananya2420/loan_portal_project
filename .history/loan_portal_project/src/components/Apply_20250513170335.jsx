...
import { setPersonalInfo, setLoanDetails, setEmployeeDetails } from '../redux/slices/formSlice'; // Add necessary actions
...
const Apply = () => {
  ...
  if (step === 5 && !isFormComplete()) {
    return <Navigate to="/apply" />; // Redirect to the form if incomplete
  }
