...
const Review = () => {
  ...
  const currentStepIndex = 5; // zero-based index for "Review" (6th step)
  ...
  return (
    ...
    >
      ...
      {/* Full Steps Navigation - styled like Apply */}
      <div className="mb-6 flex items-center max-w-md w-full">
                ...
                <div className="flex-1 h-1 mx-1 sm:mx-2 bg-gray-300 relative">
                  <div
                    className={`h-full transition-all duration-500 ${
                      currentStepIndex > index ? 'bg-blue-600 w-full' : 'w-0'
                    }`}
                  />
                </div>
              )}
      ...
      >
        ...
        <div className="relative pt-1 mb-6">
          ...
          <div className="flex h-2 overflow-hidden text-xs bg-teal-200 rounded">
            <div
              style={{ width: isSubmitting ? '100%' : '75%' }}
