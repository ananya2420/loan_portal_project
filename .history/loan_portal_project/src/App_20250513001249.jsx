...
import PortfolioPage from './components/PortfolioPage';     // ✅ Make sure this exists
    ...
    <Provider store={store}>
      <BrowserRouter>
        ...
        <div className="form-container">
          ...
          {}  <Route path="/toggle" element={<TogglePag />} /> 
            <Route path="/portfolio" element={<PortfolioPage />} /> {/* ✅ Add route */}
          </Routes>
        </div>
      </BrowserRouter>
    </Provider>
