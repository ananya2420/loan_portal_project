...
import { setLoanDetails } from '../store/formSlice'; // Now this import should work
...
const LoanDetails = () => {
  ...
  const loanDetails = useSelector((state) => state.formData.loanDetails || {}); // Add fallback to empty object
