      ...
      case 1:
        return (
          <>
            ...
            {['company', 'income', 'experience', 'taxId'].map((field) => (
        ...
        {isEditing ? (
          ...
          <>
            {[
              ...
              <div
                key={title}
                className="border border-gray-300 p-4 rounded-lg cursor-pointer hover:bg-gray-50"
                onClick={() => {
                  setIsEditing(true);
                  setEditStep(stepTitles.indexOf(title));
                  if (title === 'Personal Info') setLocalPersonalInfo(personalInfo);
                  else if (title === 'Employee Details') setLocalEmployeeDetails(employeeDetails);
                  else if (title === 'Loan Details') setLocalLoanDetails(loanDetails);
                  else if (title === 'Document Updates') setLocalDocumentUpdates(documentUpdates);
                }}
              >
