...
const Summary = () => {
  ...
  // ✅ New useEffect to reset form fields when entering edit mode
  useEffect(() => {
    if (isEditing) {
      reset({
        personalInfo,
  ...
  }, [isEditing, editStep, reset, personalInfo, employeeDetails, loanDetails, documentUpdates]);
    ...
    >
      ...
      <div className="max-w-4xl mx-auto p-6 rounded-xl shadow-lg space-y-6 bg-white">
        ...
        {isEditing ? (
          ...
          <>
            {[/* summary sections omitted here for brevity - same as your original code */]].map((section, i) => (
