...
const Summary = () => {
  ...
  const {
    ...
    defaultValues: {
      ...employeeDetails,
      isUpdated: documentUpdates.isUpdated ? 'true' : 'false',
    },
  });
  ...
  }, [employeeDetails, documentUpdates, reset]);
        ...
        {isEditingEmployee ? (
          ...
          >
            ...
            {[
              ...
              <div key={name}>
                ...
                <input
                  ...
                  className="w-full border rounded px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white border-gray-300 text-black"
                />
                {errors[name] && (
            ...
            <div>
              ...
              <select
                {...register('isUpdated', { required: 'This field is required' })}
                className="w-full border rounded px-4 py-2 bg-white border-gray-300 text-black"
              >
                <option value="true">Yes</option>
                <option value="false">No</option>
              </select>
              {errors.isUpdated && (
                <p className="text-red-500 text-sm mt-1">{errors.isUpdated.message}</p>
              )}
            </div>
            ...
            {[
              ...
              },
              {
                ...
                content: [
                  {
                    label: 'Amount',
                    value: loanDetails.amount ? `$${loanDetails.amount}` : 'N/A',
                  },
              ...
              },
              {
                ...
                content: [
                  {
                    label: 'ID Updated',
                    value: documentUpdates?.isUpdated ? 'Yes' : 'No',
                  },
                ],
              },
            ].map((section, i) => (
