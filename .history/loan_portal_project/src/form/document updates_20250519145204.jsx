...
import { toggleTheme } from '../redux/slices/themeSlice'; // <-- Use same toggle as LoanDetails
...
const DocumentUpdates = () => {
  ...
  const handleToggleTheme = () => {
    dispatch(toggleTheme()); // <-- same toggle logic as in LoanDetails
  };
  ...
  return (
    ...
    >
      {/* Theme Toggle Button (same as LoanDetails) */}
