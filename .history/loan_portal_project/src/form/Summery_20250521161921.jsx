              ...
              <div className="space-x-4">
                ...
                <button
                  onClick={() => {
                    ...
                    // Set Personal Info fields to current values for editing
                    ...
                    setLocalEmployeeDetails({
                      ...
                      income: employeeDetails?.income || '',
                      experience: employeeDetails?.experience || '',
                      taxId: employeeDetails?.taxId || '',
                    });
                    setLocalLoanDetails({
                      amount: loanDetails?.amount || '',
                      type: loanDetails?.type || '',
                      repaymentTerm: loanDetails?.repaymentTerm || '',
                      emiDate: loanDetails?.emiDate || '',
                    });
                    setLocalDocumentUpdates({
                      isUpdated: documentUpdates?.isUpdated || '',
                    });
                  }}
