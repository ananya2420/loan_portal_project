...
const LoanDetails = () => {
  ...
  const onSubmit = (data) => {
    ...
    navigate('/apply/document-updates');  // Proceed to the next page
  };
  ...
  // Back button navigates to /apply/employee-details
  const handleBack = () => {
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <div className="flex justify-between mt-4">
            <button
   type="button"
              onClick={handleBack} // Back button navigates to employee-details
