      ...
      >
        ...
        <div className="w-full max-w-md mb-6 flex justify-between text-sm font-semibold">
          <div className="flex flex-col items-center">
            <span className="w-8 h-8 flex items-center justify-center rounded-full text-white font-bold bg-gray-300">
              0
            </span>
            <span>Apply</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="w-8 h-8 flex items-center justify-center rounded-full text-white font-bold bg-blue-600">
              1
            </span>
            <span>Personal Info</span>
          </div>
          <div className="flex flex-col items-center">
            <span className="w-8 h-8 flex items-center justify-center rounded-full text-gray-600 font-bold bg-gray-300">
              2
            </span>
        ...
        {/* Existing ProgressBar (for field-level validation progress) */}
