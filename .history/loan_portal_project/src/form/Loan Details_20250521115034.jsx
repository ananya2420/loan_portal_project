...
const LoanDetails = () => {
  ...
  // Set current step to 3 (Loan Details), total steps 8, consistent with EmployeeDetails component
  const currentStep = 3;
  const totalSteps = 8;
  ...
  return (
    ...
    >
      ...
      {/* 8-step Indicator with step numbers from 0 and labels same as EmployeeDetails */}
      ...
      {/* Progress bar with exact same style as EmployeeDetails (30% or 40% for LoanDetails step?) */}
