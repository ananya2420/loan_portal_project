      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          >
            ...
            {/* Existing filtered autocomplete */}
            ...
            {/* Hover dropdown */}
            {hoverField === 'name' && (
              <ul className="absolute z-20 w-full max-h-40 overflow-auto mt-1 border rounded shadow-lg bg-white">
                {['gourab', 'bob'].map((option) => (
                  <li
                    key={option}
                    className="cursor-pointer px-3 py-2 hover:bg-green-500 hover:text-white"
