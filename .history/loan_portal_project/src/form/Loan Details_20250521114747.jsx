...
const LoanDetails = () => {
  ...
  return (
    ...
    >
      ...
      {/* 8-step progress indicator with minimal spacing */}
      <div className="grid grid-cols-8 mb-6 w-full max-w-4xl mx-auto">
        {[
          'Apply',
          'Personal Info',
          'Employee Details',
          ...
          return (
            <div
              key={label}
              className="flex flex-col items-center px-1" // small horizontal padding for minimal spacing
            >
              <div
