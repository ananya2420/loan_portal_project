...
import { toggleTheme } from '../redux/slices/themeSlice'; // <-- NEW
...
const Summary = () => {
  ...
  const theme = useSelector((state) => state.theme.theme); // <-- NEW
  ...
  const stepTitles = ['Apply','Personal Info', 'Employee Details', 'Loan Details', 'Document Updates'];
