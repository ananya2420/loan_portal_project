...
const Summery = ({ userData, onEdit, onSubmit, mode }) => {
  ...
  const handleGoToReview = () => {
    navigate('/apply/review'); // ✅ Navigate to review page
  };
    ...
    <div className="max-w-3xl mx-auto p-6 bg-white rounded-lg shadow-md space-y-6">
      ...
      {mode === 'edit' ? (
        ...
        <>
          ...
          {/* More sections for EmployeeDetails, LoanDetails, DocumentUpdates */}
          ...
          <div className="flex justify-center gap-4 mt-6">
            ...
            <button
              onClick={handleGoToReview} // ✅ This button will trigger navigation to Review page
