    ...
    >
      ...
      <div className="max-w-4xl mx-auto p-6 rounded-xl shadow-lg space-y-6 bg-white">
        ...
        {isEditing ? (
          ...
          >
            ...
            <div className="flex justify-between mt-6">
              <button
                ...
                onClick={() => {
                  if (editStep === 0) {
                    // Exit editing and go back to summary
                    setIsEditing(false);
                    setEditStep(0);
                  } else {
                    // Go to previous step in the edit form
          ...
          <>
            {/* Summary Sections including Personal Info */}
            {[
              {
                title: 'Personal Info',
                content: [
              ...
              },
              {
                title: 'Loan Details',
                content: [
                  { label: 'Amount', value: 'Brain Station' },
