...
const UpdatedPicture = () => {
  ...
  const [currentStep, setCurrentStep] = useState(5); // Assuming you are on the 5th step
  const totalSteps = 5;
  ...
  const goBack = () => {
    // Navigate to the previous step, assuming you want to go back to the Document Details page (example: '/apply/document-details')
    navigate('/apply/document-details');
  };

  // Handle Next button click
  const goNext = () => {
    // Proceed to the review or summary page
    navigate('/apply/summary');
  };
