...
const Summery = ({ userData, onEdit, onSubmit, mode, onNext, onBack }) => {
  ...
  // Function to handle 'Next' button click and navigate to login page
  const handleNext = () => {
    // Perform any actions you want here before navigating, if necessary
    navigate('/login'); // Redirect to login page on Next click
  };
