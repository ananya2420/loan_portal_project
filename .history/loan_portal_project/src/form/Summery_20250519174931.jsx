...
const Summary = () => {
  ...
  const submitEmployeeDetails = (data) => {
    // Ideally dispatch an action to update Redux store here
    // For example: dispatch(updateEmployeeDetails(data));
    // Since you don't have that, we can store locally or alert

    // For demonstration, you might want to update local state or show alert
    // But Redux dispatch is recommended
  ...
  const handleGoToReview = () => {
    navigate('/apply/review'); // Adjust if you have a review route
  };
