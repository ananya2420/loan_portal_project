...
const EmployeeDetails = () => {
  ...
  const {
    ...
    defaultValues: savedData || {
      company: 'Example Corp',  // Default company name
      income: 5000,             // Default monthly income
    },
  });
  ...
  // For controlling hover and focus of Monthly Income input
  const [focusedField, setFocusedField] = useState('');
  const [hoverField, setHoverField] = useState('');

  const incomeSuggestions = [10000, 12000, 15000];
  ...
  const handleBack = () => {
    navigate('/apply/personal-info'); // Use the correct route path here
  };
  ...
  return (
    ...
    >
      <div className="w-full max-w-md">
        {/* 8-step Indicator marking Employee Details */}
          ...
          >
            ...
            <div>
              ...
              >
                ...
                <option value="Brain station Tech solution">Brain station Tech solution</option>
                <option value="Enosis solution">Enosis solution</option>
              </select>
              {errors.company && (
            ...
            {/* Monthly Income with suggestions on hover */}
            <div
              className="relative"
            ...
            >
              ...
              {/* Suggestions dropdown shown only on hover and when NOT focused */}
