...
const PersonalInformation = () => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit((data)=>console.log(data))}>
        ...
        <label>
            Phone number 
            <input type='number' name='phonenumber' value={input.phonenumber} onChange={handleChange} {...register('phonenumber')} aria-label=''/>
        ...
        <label>
            Email address 
            <input type="email" name="email" value={input.email} onChange={handleChange} {...register('email')} aria-label=''/>
