...
import { toggleTheme } from '../redux/slices/themeSlice'; // Make sure path is correct
...
const Summary = ({ userData = {}, onSubmit }) => {
  ...
  // Validation function to check all required fields stepwise
  const isAllDataValid = () => {
    // Check Personal Info required fields
    if (!personalInfo.name || !personalInfo.dob || !personalInfo.phone || !personalInfo.email) {
      return false;
    }
    // Check Employee Details required fields
    ...
    // Check Loan Details required fields
    if (!loanDetails.amount || !loanDetails.type || !loanDetails.term || !loanDetails.emiDate) {
      return false;
    }
    // Check Document Updates required fields (example: isUpdated must be true or false)
    if (typeof documentUpdates.isUpdated !== 'boolean') {
      return false;
    }
    return true;
  };
            ...
            {[{
              ...
              },
              {
                ...
                content: [
                  ...
                  { label: 'Term', value: loanDetails.term || 'N/A' },
