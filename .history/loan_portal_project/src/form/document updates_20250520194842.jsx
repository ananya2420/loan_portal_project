...
import { setLoanDetails, setPersonalInfo } from '../redux/slices/formSlice';
...
const DocumentUpdates = () => {
  ...
  const onSubmit = (data) => {
    // Loan details dispatch removed since fields removed

    // ✅ Inject mock data for personalInfo (or ensure this comes from a previous step)
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Removed loanAmount and loanType inputs */}

        {/* Add the image at the end */}
        <img
          src="/path/to/document-updates-image.png"
