...
const Summary = () => {
  ...
  // LOCAL STATE FOR FORM EDITING (new)
  ...
  // CHANGE onSubmit to use local state instead of react-hook-form data
  const onSubmit = () => {
    ...
    switch (editStep) {
          ...
          <>
            ...
            {['name', 'dob', 'phone', 'email'].map((field) => (
              <div key={field}>
                ...
                />
                {/* You can keep react-hook-form errors or remove them */}
      ...
      case 1:
        const suggestions = {
          ...
          income: ['5000', '10000', '12000', '15000'],
          experience: ['5 years', '6 years'],
          taxId: ['tx55505', '583006'],
        };
        ...
        return (
          <>
            ...
            {['status', 'company', 'income', 'experience', 'taxId'].map((field) => {
              const isSuggestible = ['company', 'income', 'experience', 'taxId'].includes(field);
              return (
                <div key={field} className="relative">
                  ...
                  <input
                    ...
                    className="w-full border rounded px-4 py-2"
                    onFocus={() => isSuggestible && setShowSuggestions(field)}
                    onBlur={() => setTimeout(() => setShowSuggestions(null), 150)}
                  />
                  {isSuggestible && showSuggestions === field && (
                    <ul className="absolute z-10 bg-white border rounded shadow mt-1 w-full max-h-40 overflow-auto">
                      {suggestions[field].map((suggestion, idx) => (
                        <li
                          ...
                          onMouseDown={() => {
                            setLocalEmployeeDetails({ ...localEmployeeDetails, [field]: suggestion });
        ...
        {isEditing ? (
          ...
          <>
            {[
              ...
              <div
                key={title}
                className="p-4 border rounded-lg shadow-sm bg-gray-50 border-gray-200"
              >
                <div className="flex justify-between items-center mb-3">
                  ...
                  <button
                    onClick={() => {
                      setIsEditing(true);
                      setEditStep(steps.indexOf(title) - 1);
                      ...
                      } else if (title === 'Document Updates') {
