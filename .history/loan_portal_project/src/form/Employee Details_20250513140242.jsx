...
//import { setEmployeeDetails } from '../store/formSlice'; // Ensure correct path here
import {set}
...
const EmployeeDetails = () => {
  ...
  // Set a loading state while data is being fetched
  const [isLoading, setIsLoading] = useState(true);

  useEffect(() => {
    // If the savedData is available, stop the loading state
    if (savedData) {
      setIsLoading(false);
    }
  }, [savedData]);
