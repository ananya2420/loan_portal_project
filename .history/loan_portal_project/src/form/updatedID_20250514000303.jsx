...
// import Summery from './Summery'; // If not used, keep it commented or remove
...
const UpdatedPicture = () => {
  ...
  const onSubmit = (data) => {
    ...
    // ✅ Fixed path typo from "/apply/summery" to "/apply/summary"
    navigate('/apply/summary');
  };

  const goBack = () => {
    navigate('/apply/document-details'); // Make sure this route exists
  };
