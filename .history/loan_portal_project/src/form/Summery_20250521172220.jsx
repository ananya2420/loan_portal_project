      ...
      case 2:
        return (
          <>
            ...
            {/* Loan Tenure select */}
            <div>
              <label className="block font-semibold mb-1 capitalize">Tenure</label>
              <select
                {...register(`loanDetails.tenure`, { required: 'Tenure is required' })}
                className="w-full border rounded px-4 py-2"
              >
              ...
              {errors?.loanDetails?.tenure && (
                <p className="text-red-500 text-sm mt-1">{errors.loanDetails.tenure.message}</p>
              )}
            </div>
          </>
        );
      ...
      case 3:
        return (
          <>
            ...
            {/* Document select */}
            <div>
              <label className="block font-semibold mb-1 capitalize">Document</label>
              <select
                {...register(`documentUpdates.document`, { required: 'Document is required' })}
                className="w-full border rounded px-4 py-2"
              >
              ...
              {errors?.documentUpdates?.document && (
                <p className="text-red-500 text-sm mt-1">{errors.documentUpdates.document.message}</p>
              )}
            </div>
            ...
            <div>
              <label className="block font-semibold mb-1 capitalize">Status</label>
              <select
                {...register(`documentUpdates.status`, { required: 'Status is required' })}
                className="w-full border rounded px-4 py-2"
              >
                <option value="">Select Status</option>
              ...
              {errors?.documentUpdates?.status && (
                <p className="text-red-500 text-sm mt-1">{errors.documentUpdates.status.message}</p>
              )}
            </div>
          </>
        );
    ...
    <div className={`min-h-screen p-6 ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-gray-100 text-black'}`}>
      ...
      {!isEditing ? (
        <>
          ...
          <div className="mb-4">
            <h3 className="text-2xl font-semibold mb-2">Employee Details</h3>
          ...
          <div className="mb-4">
            <h3 className="text-2xl font-semibold mb-2">Loan Details</h3>
          ...
          <div className="mb-4">
            <h3 className="text-2xl font-semibold mb-2">Document Updates</h3>
            <p><strong>Document:</strong> {documentUpdates?.document}</p>
            <p><strong>Status:</strong> {documentUpdates?.status}</p>
            <button
              className="mt-2 px-4 py-2 bg-blue-600 text-white rounded"
              onClick={() => {
                setIsEditing(true);
