...
const Summery = ({ userData, onEdit, onSubmit, mode }) => {
  ...
  const {
    ...
    defaultValues: personalInfo || {} // Ensure default values are always set
  });
      ...
      {mode === 'edit' ? (
        <form onSubmit={handleSubmit(submitUpdatedInfo)} className="bg-gray-50 p-4 rounded-lg space-y-4">
          ...
          <div>
            ...
            <input
              ...
              value={personalInfo?.name || ""} // Ensure default value is empty string if undefined
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full border rounded p-2"
              value={personalInfo?.dob || ""} // Ensure default value is empty string if undefined
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full border rounded p-2"
              value={personalInfo?.phone || ""} // Ensure default value is empty string if undefined
            />
          ...
          <div>
            ...
            <input
              ...
              className="w-full border rounded p-2"
              value={personalInfo?.email || ""} // Ensure default value is empty string if undefined
            />
        ...
        <>
          ...
          <div className="flex justify-center gap-4 mt-6">
            ...
            <button
              onClick={handleGoToReview}  // Trigger review page navigation
