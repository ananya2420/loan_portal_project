                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {section.content.map((item, j) => (
                    <div key={j} className="text-sm">
                      ...
                      {['Income', 'Term', 'Amount', 'Experience'].some((word) =>
              ...
              <div className="relative group">
                <button
                  onClick={() => {
                    ...
                    // CLEAR INPUTS ON EDIT START (new)
                ...
                <div className="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 hidden group-hover:block bg-black text-white text-xs rounded py-2 px-3 z-10 whitespace-nowrap">
                  Fullname: {personalInfo?.name || 'N/A'}
                  <br />
                  Phone: {personalInfo?.phone || 'N/A'}
                </div>
              </div>

              {/* New button to navigate to Review */}
              <button
                onClick={() => navigate('/review')}
                className="px-6 py-2 bg-indigo-600 text-white font-medium rounded hover:bg-indigo-700 ml-4"
              >
                Go to Review
              </button>
            </div>
