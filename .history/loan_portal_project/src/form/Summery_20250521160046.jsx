          ...
          <>
              ...
              <section key={i} className="p-5 rounded-lg border bg-gray-50 border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {section.content.map((item, j) => {
                    if (item.label === 'Name') {
                      return (
                        <div key={j} className="text-sm relative group inline-block">
            ...
            <div className="flex justify-between mt-6">
              ...
              <div className="relative group">
                ...
                <div className="absolute hidden group-hover:block bg-gray-800 text-white text-xs rounded py-1 px-3 mt-1 whitespace-nowrap -left-2">
