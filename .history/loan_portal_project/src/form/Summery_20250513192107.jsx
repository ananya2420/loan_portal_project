...
const Summery = ({ userData, onEdit, onSubmit, mode, onBack }) => {
  ...
  const handleNext = () => {
    navigate('/apply/review'); // Navigate to Review page directly
  };
        ...
        <>
          ...
          <div className="flex justify-between gap-4 mt-6">
            ...
            <div className="flex gap-4">
              ...
              {/* Handle Next Button */}
            <button type="button" onClick={handleNext} className="px-5 py-2 bg-green-600 text-white rounded hover:bg-green-700">
  Next
</button>
            </div>
          </div>
