...
const Summary = () => {
  ...
  content: [
    { label: 'Name', value: 'Gourab Sen' },
    { label: 'Date of Birth', value: '01/01/1990' },
    { label: 'Phone', value: '1234567890' },
    { label: 'Email', value: 'gourab@gmail.com' },
  ],
},

              {
                ...
                content: [
                  ...
                  { label: 'Monthly Income', value: employeeDetails.income ? `$${employeeDetails.income}` : '5000' },
                  { label: 'Experience', value: employeeDetails.experience ? `${employeeDetails.experience} years` : 'N/A' },
                  { label: 'Tax ID', value: 'TX999888777'},
                ],
              },
              {
                title: 'Loan Details',
                content: [
                  { label: 'Amount', value: '20000 'N/A' },
